...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $check_email_query = "SELECT * FROM reg3 WHERE email='$email'";
    $check_email_result = $conn->query($check_email_query);

    if ($check_email_result->num_rows > 0) {
        $error_message = "Email already exists. Please choose a different email.";
    }else{
        $sql = "INSERT INTO reg3 (tname,name1, number, email,userid1,name2,userid2,name3,userid3,name4,userid4,name5,userid5) VALUES ('$tname','$name1','$number','$email', '$userid1','$name2','$userid2','$name3','$userid3','$name4','$userid4','$name5','$userid5')";
...
<div class="container">
    ...
    <form action="" method="POST">
        ...
        <label for="UserID">UserID : </label>
        <input type="text" id="userid5" name="userid5" required><br>
