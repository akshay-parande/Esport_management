    ...
    <table>
        ...
        <?php
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                // Determine the registration page based on the counter variable
                if ($counter == 1) {
                    echo "<td><a href='reg_valo.php'><button>Register</button></a></td>";
                }else if($counter == 2){
                    echo "<td><a href='reg_valo2.php'><button>Register</button></a></td>";
                }
                else if($counter == 3){
                    echo "<td><a href='reg_valo3.php'><button>Register</button></a></td>";
                }
    ...
    <table>
        ...
        <?php
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                // Determine the registration page based on the counter variable
                if ($counter == 1) {
                    echo "<td><a href='pointsvalo.php'><button>Points Table</button></a></td>";
                }else if($counter == 2){
                    echo "<td><a href='pointsvalo1.php'><button>Points Table</button></a></td>";
                }
                else if($counter == 3){
                    echo "<td><a href='pointsvalo2.php'><button>Points Table</button></a></td>";
                }
