...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($check_email_result->num_rows > 0) {
        ...
        $sql = "INSERT INTO reg (tname,name1, number, email,userid1,name2,userid2,name3,userid3,name4,userid4,name5,userid5) VALUES ('$tname','$name1','$number','$email', '$userid1','$name2','$userid2','$name3','$userid3','$name4','$userid4','$name5','$userid5')";
